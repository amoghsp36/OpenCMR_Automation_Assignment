...
public class OperationsPage extends BasePage{
    ...
    By scheduling = By.cssSelector("#appointmentschedulingui-homeAppLink-appointmentschedulingui-homeAppLink-extension");
    ...
    public Appointment AppointmentScheduling(){
        pageActions.click(scheduling);
